...
<div class="noVerEnPantalla">
    <div style="width: 100%;">
        ...
        <div  style="width: 20%; float: left;">
            <?php if ($student->profile_photo != "" && $student->profile_photo != "Sin foto") : ?>
                <?= $this->Html->image('../files/students/profile_photo/' . $student->get('profile_photo_dir') . '/'. $student->get('profile_photo'), ["height" => "200"]) ?>
            <?php else: ?>
    ...
    <div style="clear:both; width: 100%;">
        <?php if ($student->new_student == 0): ?>
            ...
            <ul>
                ...
                if ($indicadorDeudaInscripcion == 1)
                { ?>
                    <li><b>TOTAL A CANCELAR = 612$</b></li>
                <?php
                }
                else
                { ?>
                    <li><b>TOTAL A CANCELAR = 526$</b></li>
                <?php
                } ?>
            </ul>
        <?php endif; ?>    
    ...
    <div class="saltopagina" style="font-size: 10px;">
        ...
        <div style="border-style: solid; border-width: 1px; padding: 1%;">
            ...
            <p style="text-align: justify;">2. Fotografía tipo carnet reciente en digital, la misma debe adjuntarse en el formulario de actualización de datos no se puede imprimir.</p>
            <p style="text-align: justify;">3. Traer 1 foto carnet actualizada en físico para anexarla en el historial académico.</p>
            <p style="text-align: justify;">4. Factura del mes de julio 2026.</p>
            <p style="text-align: justify;">5. Recibo del Consejo educativo 2025-2026.</p>
        ...
        <p>2. Con el pago del mes de Julio 2026.</p>
        <p>3. Con el pago del Consejo Educativo 2025-2026.</p>            
        ...
        <p>5. Los pagos realizados en bolívares deben ser a la tasa referencial del Banco Central de Venezuela del día a transferir, solo para la mensualidad (es) pendiente(s), de esta manera no se aceptará el pago de mensualidades adelantadas al mes en curso, puede realizar el pago del mes de lunes a viernes en un horario comprendido de 8.00 am a 1.00 pm solo días laborables.</p>
        <p>6. En clases presenciales es obligatorio según resolución 38160 el Seguro Escolar por lo tanto como padre y representante debe cumplir con dicho requisito.</p>
        <p>7. Las mensualidades se vencen los primeros 5 días de cada mes.</p>
        ...
        <p>9. Esta información la encontrará siempre en la página web del colegio SGA y familiarícese con nuestros “Normativos de Sana Convivencia” y “Aspectos Administrativos”.</p>
        <p>10. Manifiesto estar informado (a) en conocimiento de lo expresado en el artículo 12 del M.P.P.E</p>
        <p>11. Todos los niños, niñas y adolescentes tienen derecho al buen trato. Este derecho comprende una crianza y educación no violenta con respeto y comprensión mutua. Por ello si en caso de que su hijo (a) sea agente violento dentro del aula o perturbador que limiten la fluidez y la sana convivencia tiene la obligación de cumplir con asesorías psicológicas y terapias conductuales necesarias para que en clases de forma armoniosa y así mantener la sana convivencia.</p>
        <p>12. Luego de haber leído el manual de convivencia en la página web del Colegio manifiesto cumplirlo y firmo conforme: </p>
        <div>
...
<div class="container noVerImpreso">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <?php if ($student->profile_photo != "" && $student->profile_photo != "Sin foto") : ?>
                <?= $this->Html->image('../files/students/profile_photo/' . $student->get('profile_photo_dir') . '/'. $student->get('profile_photo'), ['height' => '200', 'class' => 'img-thumbnail img-responsive']) ?>
            <?php else: ?>
                <div style="text-align: center; width: 200px; height: 200px; border: 3px solid #555;">
                    <p>Foto</p>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="#" id="imprimir-planilla" class="glyphicon glyphicon-print iconoMenu" title="Imprimir pantalla"></a>
        </div>
    </div>
</div>
<br />
...
<script>
    ...
    {
        $('#imprimir-planilla').click(function(e)
        {
            e.preventDefault();							
		    imprimirPantalla();
        });					
