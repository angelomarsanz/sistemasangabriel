							...
							<tbody id='table-payment'>
								...
								?>
									<tr id=<?= 'emp' . $employeesFors->id ?> class='linea-empleado'>
										...
										<td class="<?= $tableConfiguration->date_of_admission ?>"><input disabled='true' class='input-fecha-ingreso' style="text-align: center; width: 100%;" name="employeepayment[<?= $accountArray ?>][date_of_admission]" value=<?= $employeesFors->employee->date_of_admission->format('d-m-Y') ?>></td>

										<td class="<?= $tableConfiguration->monthly_salary ?>"><input disabled='true' class='input-sueldo-mensual' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][monthly_salary]" class="alternative-decimal-separator" value=<?= number_format(($employeesFors->monthly_salary), 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->payment_period ?>"><input disabled='true' class='input-pago-periodo' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][payment-period]" class="alternative-decimal-separator" value=<?= number_format($employeesFors->payment_period, 2, ",", ".") ?>></td>
									
										<td class="<?= $tableConfiguration->amount_escalation_period ?>"><input disabled='true' class='input-escalafon-periodo' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][amount_escalation_period]" class="alternative-decimal-separator" value=<?= number_format(($employeesFors->amount_escalation/2), 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->other_income ?>"><input class='input-otros-ingresos alternative-decimal-separator' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][other_income]" value=<?= number_format($employeesFors->other_income, 2, ",", ".") ?>></td> 
			
										<td class="<?= $tableConfiguration->faov ?>" style='text-align: right;'><input disabled='true' class='input-faov' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][faov]" value=<?= number_format($employeesFors->faov, 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->ivss ?>" style='text-align: right;'><input disabled='true' class='input-ivss' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][ivss]" value=<?= number_format($employeesFors->ivss, 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->trust_days ?>" style='text-align: right;'><input class='input-dias-fideicomiso alternative-decimal-separator' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][trust_days]" value=<?= number_format($employeesFors->trust_days, 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->escrow ?>" style='text-align: right;'><input disabled='true' class='input-fideicomiso' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][escrow]" value=<?= number_format(($employeesFors->trust_days * $employeesFors->integral_salary), 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->discount_repose ?>"><input class='input-reposo alternative-decimal-separator' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][discount_repose]" class="alternative-decimal-separator" value=<?= number_format($employeesFors->discount_repose, 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->salary_advance ?>"><input class='input-adelanto-sueldo alternative-decimal-separator' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][salary_advance]" class="alternative-decimal-separator" value=<?= number_format($employeesFors->salary_advance, 2, ",", ".") ?>></td>
									
										<td class="<?= $tableConfiguration->discount_loan ?>"><input class='input-prestamos alternative-decimal-separator' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][discount_loan]" class="alternative-decimal-separator" value=<?= number_format($employeesFors->discount_loan, 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->percentage_imposed ?>"><input class='input-porcentaje-impuesto alternative-decimal-separator' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][percentage_imposed]" class="alternative-decimal-separator" value=<?= number_format($employeesFors->percentage_imposed, 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->amount_imposed ?>"><input  disabled='true' class='input-monto-impuesto' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][amount_imposed]" class="alternative-decimal-separator" value=<?= number_format($employeesFors->amount_imposed, 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->days_absence ?>" style='text-align: right;'><input class='input-dias-inasistencias alternative-decimal-separator' style="text-align: right; width: 100%;" name="employeepayment[<?= $accountArray ?>][days_absence]" value=<?= number_format($employeesFors->days_absence, 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->discount_absences ?>"><input disabled='true' class='input-inasistencia' style='text-align: right; width: 100%;' name="employeepayment[<?= $accountArray ?>][discount_absences]" value=<?= number_format($employeesFors->discount_absences, 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->total_payment ?>"><input disabled='true' class='input-total-payment' style='text-align: right; width: 100%;' name="employeepayment[<?= $accountArray ?>][total_payment]" value=<?= number_format($employeesFors->total_payment, 2, ",", ".") ?>></td>

										<td class="<?= $tableConfiguration->days_cesta_ticket ?>"><input class='input-days-cesta-ticket alternative-decimal-separator' style='text-align: right; width: 100%;' name="employeepayment[<?= $accountArray ?>][days_cesta_ticket]" value=<?= number_format($employeesFors->days_cesta_ticket, 2, ",", ".") ?>></td>
								
										<td class="<?= $tableConfiguration->amount_cesta_ticket ?>"><input disabled='true' class='input-amount-cesta-ticket' style='text-align: right; width: 100%;' name="employeepayment[<?= $accountArray ?>][amount_cesta_ticket]" value=<?= number_format($employeesFors->amount_cesta_ticket, 2, ",", ".") ?>></td>
								
										<td class="<?= $tableConfiguration->loan_cesta_ticket ?>"><input class='input-loan-cesta-ticket alternative-decimal-separator' style='text-align: right; width: 100%;' name="employeepayment[<?= $accountArray ?>][loan_cesta_ticket]" value=<?= number_format($employeesFors->loan_cesta_ticket, 2, ",", ".") ?>></td>
									
										<td class="<?= $tableConfiguration->total_cesta_ticket ?>"><input disabled='true' class='input-total-cesta-ticket' style='text-align: right; width: 100%;' name="employeepayment[<?= $accountArray ?>][total_cesta_ticket]" value=<?= number_format($employeesFors->total_cesta_ticket, 2, ",", ".") ?>></td>	
									</tr>
								<?php 
									$accountArray++; 
									$accountEmployee++;
