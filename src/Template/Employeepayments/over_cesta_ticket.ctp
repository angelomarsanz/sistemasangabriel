...
<div>
    ...
    <?php foreach ($employeesFor as $employeesFors): ?>
		...
		<div style='clear=both; width: 100%; float:left;'>
			<p style='text-align: center;'><b>RECIBO DE PAGO DE CESTA TICKET</b></p>
		</div>
		<div style='clear: both; width: 100%; float:left;'>
		...
		<div style='clear: both; width: 100%; float:left;'>
			...
			<div style='width: 20%; float:left; text-align: right;'>
				<p><?= number_format($employeesFors->total_cesta_ticket, 2, ",", ".") ?></p>
				<p>&nbsp;</p>
				<hr style='border-color: black;'>
			</div>	
			<div style='width: 10%; float:left;'>
			...
			<div style='width: 20%; float:left; text-align: right;'>
				<p><?= number_format($employeesFors->loan_cesta_ticket, 2, ",", ".") ?></p>
				<hr style='border-color: black;'>
			</div>
		</div>	
		<?php $totAsignaciones = $employeesFors->amount_cesta_ticket; ?>
		<?php $totDeducciones = $employeesFors->amount_cesta_ticket - $employeesFors->loan_cesta_ticket ?>
		<div style='clear: both; width: 100%; float:left;'>
			<div style='width: 25%; float:left;'>
				<p>Total asig:</p>
				<p>Recibí conforme:</p>
