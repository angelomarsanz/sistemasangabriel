...
<div>
    ...
    <?php foreach ($employeesFor as $employeesFors): ?>
		...
		<div style='clear=both; width: 100%; float:left;'>
			<p style='text-align: center;'><b>COMPROBANTE DE RETENCIÓN I.S.L.R</b></p>
		</div>
		<div style='clear: both; width: 100%; float:left;'>
		...
		<div style='clear: both; width: 100%; float:left;'>
			...
			<div style='width: 30%; float:left;'>
				<p><b>MONTO RETENIDO</b></p>
				<hr style='border-color: black;'>
			</div>				
		</div>
		<div style='clear: both; width: 100%; float:left;'>
			<div style='width: 30%; float:left;'>
				<p>Retención I.S.L.R.</p>
				<p>Mes de: <?= $month . ' ' . $year ?></p>
				<hr style='border-color: black;'>
			</div>
			<div style='width: 5%; float:left;'>
				<p>&nbsp;</p>	
			...
			<div style='width: 30%; float:left;'>
				<p style='text-align: right;'><?= number_format($employeesFors->percentage_imposed, 2, ",", ".") ?></p>
				<p>&nbsp;</p>	
				<hr style='border-color: black;'>
			</div>
			<div style='width: 5%; float:left;'>
			...
			<div style='width: 30%; float:left;'>
				<p style='text-align: right;'><?= number_format($employeesFors->amount_imposed, 2, ",", ".") ?></p>
				<p>&nbsp;</p>	
				<hr style='border-color: black;'>
			</div>
		</div>	
		<div style='clear: both; width: 100%; float:left;'>
			...
			<div style='width: 30%; float:left;'>
				<p>&nbsp;</p>
				<p style='text-align: right;'><b>Total retenciones:</b></p>
				<p>&nbsp;</p>
				<hr style='border-width: 5px; border-color: black;'>
			</div>
			<div style='width: 5%; float:left;'>
