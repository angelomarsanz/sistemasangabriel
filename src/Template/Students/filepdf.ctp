    ...
    <div class="row">
        <div class="col-sm-12">
            <?php if ($student->new_student == 0): ?>
                ...
                <p>Diferencia de Matrícula 2022 - 2023 = 30$ - Diferencia de Agosto 2022 - 2023 =  30$ - Anticipo de Matrícula 2023 - 2024 =  120$</p>
                <p>Abono a Agosto 2023 - 2024 =  120$ - Seguro Escolar 2023 - 2024 = 20 $ (Pago único en dólares en efectivo) - <b>TOTAL A CANCELAR 320 $</b></p>
            <?php endif; ?>    
            <br />
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div style="border-style: solid; border-width: 1px; padding: 1%;">
                <p style="text-align: justify;">- Fotocopia de la cédula de identidad (de 4to. Grado hasta 2do. Año es indispensable por orden del M.P.P.E.).</p>
                ...
                <p style="text-align: justify;">- Factura del mes de julio 2024.</p>
                <p style="text-align: justify;">- Recibo del Consejo Educativo 2023-2024 (En efectivo).</p>
            </div>
            <p>&nbsp;</p>
            <p>- <b>Horario de inscripción: 8:00 am - 12:30 m</b> de lunes a viernes.</p>
            <p>- Se formaliza la inscripción del alumno cuando:</p>
            <ul>
                <li>1. Cuando se entrega esta ficha rellena con los datos actualizados.</li>
                <li>2. Con el pago del mes de Julio 2024.</li>
                <li>3. Con el pago del Consejo Educativo 2024.</li>            
            </ul>
            ...
            <p>2. Solicitamos que actualice en la plataforma web del Colegio: http://colegiosangabrielarcángel.com Los cambios de residencia o números telefónicos que pudieron haber ocurrido en el año escolar. En la sección: <b>Actualización de Datos y Renovación de Matrícula”.</b></p>
            ...
            <p>7. Los pagos realizados en bolívares deben ser a la tasa referencial del Banco Central de Venezuela del día a transferir, solo para la mensualidad (es) pendiente(s), de esta manera no se aceptará el pago de mensualidades adelantadas al mes en curso.</p>
            <p>8. En clases presenciales es obligatorio el Seguro Escolar por lo tanto como padre y representante debe cumplir con dicho requisito.</p>
            <p>9. Las mensualidades se vencen los primeros 5 días de cada mes.</p>
            <p>10. Esta información debe ser impresa en el revés de la ficha de inscripción, la firmará el padre o representante y entregará en Administración. </p>
            <p>11. Esta información la encontrará siempre en la página web del colegio SGA y familiarícese con nuestros “Normativos de Sana Convivencia” y "Aspectos Administrativos".</p>
            <p>12. Manifiesto estar informado (a)  en conocimiento de lo expresado en el artículo 12 del  M.P.P.E</p>
        </div>
    </div>
    <br />
    <br />
...
<div class="noVerPantalla">
    ...
    <div style="clear:both; width: 100%;">
        <?php if ($student->new_student == 0): ?>
            ...
            <ul>
                <li>Diferencia de Matrícula 2022 - 2023 = 30$ - Diferencia de Agosto 2022 - 2023 =  30$</li>
                <li>Anticipo de Matrícula 2023 - 2024 =  120$ - Abono a Agosto 2023 - 2024 =  120$</li>
                <li>Seguro Escolar 2023 - 2024 = 20 $ (Pago único en dólares en efectivo) - <b>TOTAL A CANCELAR 320 $</b></b></li>
            </ul>
        <?php endif; ?>    
