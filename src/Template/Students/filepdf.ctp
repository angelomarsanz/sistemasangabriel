...
<div class="container noVerImpreso">
    ...
    <div class="row">
        <div class="col-sm-12">
            <?php if ($student->new_student == 0): ?>
                ...
                <p>Diferencia de Matrícula 2020 - 2021 = 20 $ - Diferencia de Agosto 2020 - 2021 = 20 $ - Anticipo de Matrícula 2021 – 2022 = 65 $ - Abono a Agosto 2021 - 2022 = 65 $</p>
            <?php endif; ?>    
            <br />
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h3 style="text-align: center"><b>Información</b></h3>
