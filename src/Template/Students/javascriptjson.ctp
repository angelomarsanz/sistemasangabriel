...
<button id="save-Payments" class="btn btn-success">Guardar pagos</button>
...
$(document).ready(function()
{
    $("#save-Payments").click(function () 
    {
        ...
        printDues += "<p>Padre: " + dues.nameParent + "</p>";
        
        printDues += "<p>Saldo total factura: " + dues.totalBalance + "</p>";
        ...
        $.each(dues.students, function(indice, valor) 
        {
            $.each(valor, function(indice2, valor2)
            {
                ...
                {
                    printDues += "<p>Alumno: " + valor2 + "</p>";
                }
                if (indice2 == 'studentBalance')
                {
                    printDues += "<p>Saldo alumno: " + valor2 + "</p>";
                }
                if (indice2 == 'transactionStudents')
                {
                    ...
                    $.each(valor2, function(indice3, valor3)
                    {
                        ...
                        {
                            if (indice4 == 'id')
                                printDues += "<p> id: " + valor4 + "</p>";
                            else if (indice4 == 'share')
                                printDues += "<p> Cuota: " + valor4 + "</p>";
                            else
                                printDues += "<p> Monto: " + valor4 + "</p>";
                        });
                    });
                }
            });
