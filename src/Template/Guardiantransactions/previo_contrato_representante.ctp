...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div style="text-align: justify;">
			...
			<br />
			<p><b>CLAUSULA QUINTA:</b> "EL REPRESENTANTE" se compromete a cancelar a "U.E.C. SAN GABRIEL ARCÁNGEL, C.A."  por la prestación de los servicios educativos correspondientes al año escolar 2024-2025, el pago de trece (13) cuotas de la siguiente manera: Once (11) cuotas que deberán ser canceladas en mensualidades por adelantadas los primeros cinco (05) días de cada mes (desde Septiembre 2024 a Julio 2025), dos (02) cuotas restantes correspondientes la Inscripción (Anticipo de Matrícula año escolar 2024-2025 y Anticipo del mes Agosto del 2025), debido al aumento de las mensualidades dentro del año escolar 2023-2024 se debe cancelar la diferencia correspondiente a (diferencia de Matricula año escolar 2023-2024 y diferencia del mes Agosto 2024). </p>
			<br />
			...
			<br />
			<p><b>CLÁUSULA DÉCIMA SEGUNDA:</b> Tal como expresa el artículo 54 dela Ley Orgánica para la Protección del Niño Niña y Adolescente: <i>"Es obligación de los padres y representantes o responsables en materia educación los padres representantes o responsables tiene la obligación inmediata de garantizar la educación de los niños y adolescentes en consecuencia deben inscribirlos oportunamente en una escuela plantel o institución de educación de conformidad con la ley así como exigirle su asistencia regular a clases y participar activamente en su proceso educativo”.</i></p>
			<br />
			...
			<br />
			<p><b>CLÁUSULA DÉCIMA CUARTA:</b> Se elige como domicilio especial y único y excluyente de cualquier otro para el cumplimiento de las obligaciones contraídas en este contrato a la ciudad y municipio Valencia del estado Carabobo a la jurisdicción de cuyos Tribunales nos sometemos.</p>
			<p><b>CLÁUSULA DÉCIMA QUINTA:</b> Todos los niños, niñas y adolescentes tienen derecho al buen trato. Este derecho comprende una educación no violenta o inadecuadas con respeto y comprensión mutua. Por ello si en caso de que su hijo (a) presente conductas violentas dentro del aula que limiten la fluidez y la sana convivencia tiene la obligación de cumplir con asesorías psicológicas de equipos multidisciplinarios cumpliendo con terapias necesarias para que la clase se desarrolle de forma armoniosa y así mantener la sana convivencia. Firma conforme:</p>
			...
			<div class="noVerImpreso">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
						...
						{ 
							echo $this->Html->link('Proceder a la firma', ['controller' => 'Guardiantransactions', 'action' => 'firmaContratoRepresentante', $representante->id], ['class' => 'btn btn-success']); 
						}
