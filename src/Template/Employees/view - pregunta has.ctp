...
<div class="container">
    ...
    <div class="row">
        <div class="col col-sm-8">    
            ...
            <br />
            <br />
                <b>Cargo que ocupa:&nbsp;</b><?= $employee->has('position') ? $this->Html->link($employee->position->position, ['controller' => 'Positions', 'action' => 'view', $employee->position->id]) : '' ?>
            <br />
            <br />
            ...
            <br />
            <br />
                <b>Máximo número de secciones a asignar:&nbsp;</b><?= $this->Number->format($employee->maximum_number_sections) ?>
            <br />
            <br />
