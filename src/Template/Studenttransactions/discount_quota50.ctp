...
<div>
    ...
    <?php foreach ($arrayDiscounts as $arrayDiscount): ?> 
        <?php if ($accountItem == 1): ?>
            ...
            <h3 style="text-align: center;">Alumnos a los que se les Aplicó el Descuento del 50% y 20% en las Mensualidades</h3>
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">Nro.</th>
    ...
    <p><b><?= 'Total familias con tres hijos: ' . $accountCuatroOmas ?></b></p>
</div>
...
$(document).ready(function(){ 
    ...
    $("#excel").click(function(){
        ...
        $("#descuentos").table2excel({
            ...
            name: "descuento 50% y 20%",
        
            filename: "descuento 50 y 20 porciento" 
