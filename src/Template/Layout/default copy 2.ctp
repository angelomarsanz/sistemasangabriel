...
<head>
    ...
    <?= $this->Html->script(['jquery-3.1.1.min', 'jquery-ui.min', 'bootstrap.min', 'jquery.redirect', 'jquery.numeric.min', 'jquery.table2excel.min', 'signature_pad.umd.min', 'csga.js?ver='.time(), '/js_csga/main-script.js?ver='.time() ]) ?>
