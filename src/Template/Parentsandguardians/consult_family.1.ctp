...
<div class="row">
    <div class="col-md-6 col-md-offset-3">
        <div class="page-header">
            ...
            <p>La consulta se puede hacer por los apellidos que identifican la familia, el apellido de la madre o el apellido del representante, como usted prefiera...</p>
        </div>
