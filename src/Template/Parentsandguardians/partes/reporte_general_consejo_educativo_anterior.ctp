...
{
    if ($familia->student->parentsandguardian->familias_relacionadas_anterior !== null)
    {
        $familiasRelacionadas = json_decode($familia->student->parentsandguardian->familias_relacionadas_anterior);
...
foreach ($familiasConsejoEducativo as $familia)
{
    $familiaActual = $familia->student->parentsandguardian->family.$familia->student->parentsandguardian->id;
    ...
    $contadorEstudiantes++;
    if ($familiaAnterior != $familiaActual): 
        if ($familia->student->parentsandguardian->consejo_exonerado_anterior > 0): 
            $totalFamiliasExoneradas++;
            $familiaExoneradaVinculada = 1;
        elseif (isset($idFamiliasRelacionadas[$familia->student->parentsandguardian->id])): 
            $totalFamiliasRelacionadas++;
            $familiaExoneradaVinculada = 1;
        endif; 
        if ($familiaExoneradaVinculada == 0):
            $proyeccionCobroFamilias += $tarifaConsejoEducativo->amount;
            if (isset($idRepresentantePagos[$familia->student->parentsandguardian->id])): 
    ...
    if ($familia->student->number_of_brothers < $anioEscolarRequerido): 
        $contadorEstudiantesRegulares++;
    else: 
        $contadorEstudiantesNuevos++;        
    endif; 
    if ($familia->student->discount == 100):
        $contadorEstudiantesBecasCompletas++;
    elseif ($familia->student->discount > 0 && $familia->student->discount < 100):
        ...
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;"><b>Condicion Estudiante</b></th>
            ...
            <tbody>				
                ...
                foreach ($familiasConsejoEducativo as $familia): 
                    ...
                    <tr>
                        ...
                        if ($familiaAnterior != $familiaActual): ?>
                            <td>
                                <?= $familia->student->parentsandguardian->family." (".$familia->student->parentsandguardian->surname." ".$familia->student->parentsandguardian->first_name.")" ?>
                            </td>
                        <?php
                        else: ?>
                            <td></td>
                        ...
                        <td><?= $familia->student->full_name; ?></td>     
                        <td><?= $familia->student->section->full_name ?></td>
                        <td>
                            <?php
                            if ($familia->student->number_of_brothers < $anioEscolarRequerido): ?>
                                Regular
                        ...
                        <td>
                            <?php
                                if ($familia->student->student_condition == 'Regular'):
                                    if ($familia->student->number_of_brothers < $anioEscolarRequerido): 
                                        echo 'Regular';
                                    else:
                                        echo 'Nuevo';
                                    ...
                                    echo $familia->student->student_condition;
                                endif;
                            ?>
                        </td>
                        <td style="text-align: center">
                            <?= $familia->student->discount."%" ?>
                        </td>
                        <td style="text-align: center;">
                            <?php 
                            if ($familiaAnterior != $familiaActual): 
                                if (isset($idFamiliasRelacionadas[$familia->student->parentsandguardian->id])): 
                                    $familiaExoneradaVinculada = 1; ?>
                                    Sí
                                <?php
                                elseif ($familia->student->parentsandguardian->consejo_exonerado_anterior > 0): 
                                    $familiaExoneradaVinculada = 1; ?>
                                    Sí
                                <?php
                                else: ?>
                        ...
                        <td style="text-align: center;">
                            ...
                            if ($familiaAnterior != $familiaActual): 
                                // if ($familiaExoneradaVinculada == 0):
                                    if (isset($idRepresentantePagos[$familia->student->parentsandguardian->id])): 
                                        echo $idRepresentantePagos[$familia->student->parentsandguardian->id];
                                    endif;
                                // else:
                                //   echo '';
                                // endif;
