...
<div class="row">
    <div class="col-md-10 col-md-offset-1">
        ...
        <fieldset>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('surname', ['label' => 'Primer apellido: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('second_surname', ['label' => 'Segundo apellido:']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('first_name', ['label' => 'Primer nombre: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('second_name', ['label' => 'Segundo nombre:']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <?php echo $this->Form->input('sex', ['options' => [null => " ", 'M' => 'Masculino', 'F' => 'Femenino'], 'label' => 'Sexo: *']); ?>
                        </div>
                        <div class="col-md-4">
                            <?php echo $this->Form->input('type_of_identification', ['options' => [null => ' ', 'V' => 'Cédula venezolano', 'E' => 'Cédula extranjero', 'P' => 'Pasaporte'], 'label' => 'Tipo de identificación: *']); ?>
                        </div>
                        <div class="col-md-4">
                            <?php echo $this->Form->input('identidy_card', ['label' => 'Número C.I./Pasaporte: *', 'type' => 'number']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('cell_phone', ['label' => 'Número celular: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('landline', ['label' => 'Teléfono fijo: *']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo $this->Form->input('address', ['label' => 'Dirección de habitación: *']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('profession', ['label' => 'Profesión u oficio: *']); ?>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo $this->Form->input('item_not_specified', ['label' => 'Especifique si el rubro no está en la lista:', 'disabled' => 'disabled']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('workplace', ['label' => 'Empresa donde trabaja: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('professional_position', ['label' => 'Puesto que ocupa: *']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <?php echo $this->Form->input('work_address', ['label' => 'Dirección del trabajo: *']); ?>
                        </div>
                        <div class="col-md-4">
                            <?php echo $this->Form->input('work_phone', ['label' => 'Teléfono de trabajo: *']); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <?php echo $this->Form->input('family', ['label' => 'Apellidos que identifican su familia: *']); ?>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <p><b>Modifique si no son los correctos:</b></p>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('surname_father', ['label' => 'Primer apellido: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('second_surname_father', ['label' => 'Segundo apellido:']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('first_name_father', ['label' => 'Primer nombre: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('second_name_father', ['label' => 'Segundo nombre:']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('type_of_identification_father', ['options' => [null => " ", 'V' => 'Cédula venezolano', 'E' => 'Cédula extranjero', 'P' => 'Pasaporte'], 'label' => 'Tipo de identificación: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('identidy_card_father', ['label' => 'Nro. documento: *', 'type' => 'number']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('cell_phone_father', ['label' => 'Nro. Celular: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('landline_father', ['label' => 'Teléfono residencial: *']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo $this->Form->input('email_father', ['label' => 'Email: *']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo $this->Form->input('address_father', ['label' => 'Dirección: *']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('profession_father', ['label' => 'Profesión u oficio: *']); ?>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo $this->Form->input('rubro_trabajo_padre_no_especificado', ['label' => 'Especifique si el rubro no está en la lista:', 'disabled' => 'disabled']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('lugar_trabajo_padre', ['label' => 'Empresa donde trabaja: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('puesto_trabajo_padre', ['label' => 'Puesto que ocupa: *']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <?php echo $this->Form->input('direccion_trabajo_padre', ['label' => 'Dirección del trabajo: *']); ?>
                        </div>
                        <div class="col-md-4">
                            <?php echo $this->Form->input('work_phone_father', ['label' => 'Teléfono trabajo: *']); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('surname_mother', ['label' => 'Primer apellido: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('second_surname_mother', ['label' => 'Segundo apellido:']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('first_name_mother', ['label' => 'Primer nombre: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('second_name_mother', ['label' => 'Segundo nombre:']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('type_of_identification_mother', ['options' => [null => " ", 'V' => 'Cédula venezolana', 'E' => 'Cédula extranjera', 'P' => 'Pasaporte'], 'label' => 'Tipo de identificación: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('identidy_card_mother', ['label' => 'Nro. documento: *', 'type' => 'number']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('cell_phone_mother', ['label' => 'Nro. Celular: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('landline_mother', ['label' => 'Teléfono residencial: *']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo $this->Form->input('email_mother', ['label' => 'Email: *']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo $this->Form->input('address_mother', ['label' => 'Dirección: *']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('profession_mother', ['label' => 'Profesión u oficio: *']); ?>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo $this->Form->input('rubro_trabajo_madre_no_especificado', ['label' => 'Especifique si el rubro no está en la lista:', 'disabled' => 'disabled']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo $this->Form->input('lugar_trabajo_madre', ['label' => 'Empresa donde trabaja: *']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->input('puesto_trabajo_madre', ['label' => 'Puesto que ocupa: *']); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <?php echo $this->Form->input('direccion_trabajo_madre', ['label' => 'Dirección del trabajo: *']); ?>
                        </div>
                        <div class="col-md-4">
                            <?php echo $this->Form->input('work_phone_mother', ['label' => 'Teléfono trabajo: *']); ?>
                        </div>
                    </div>
                </div>
            </div>

            <b>Datos para la factura:</b>
            <div class="panel panel-default">
                <div class="panel-body text-center">
                    <div class="btn-group" role="group">
                        <button type="button" id="guardian-data" class="btn btn-success">Cargar Representante</button>
                        <button type="button" id="father-data" class="btn btn-success">Cargar Padre</button>
                        <button type="button" id="mother-data" class="btn btn-success">Cargar Madre</button>
                    </div>
                    <hr />
                    <div class="text-left">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <?= $this->Form->input('type_of_identification_client', ['options' => [null => "", 'V' => 'Cédula venezolano', 'E' => 'Cédula extranjero', 'P' => 'Pasaporte', 'J' => 'Rif Jurídico', 'G' => 'Rif Gubernamental'], 'label' => 'Tipo ID:', 'class' => 'campo-resaltado']) ?>
                                <div id="mensaje-tipo-de-identificacion" class="mensajes-usuario"></div>
                            </div>
                            <div class="col-md-4">
                                <?= $this->Form->input('identification_number_client', ['label' => 'Número ID/RIF:', 'class' => 'entero campo-resaltado']) ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <?= $this->Form->input('fiscal_address', ['label' => 'Dirección Fiscal:', 'class' => 'campo-resaltado']) ?>
        ...
        <div class="text-center">
            <?= $this->Form->button(__('Guardar Cambios'), ['id' => 'save-parentsandguardians', 'class' =>'btn btn-lg btn-success']) ?>
        </div>
        <?= $this->Form->end() ?>
        <br />
    </div>
