		...
		else
		{
			...
			if ($codigoRetornoResultado == 0)
			{
				foreach ($pagosFacturas as $pago)
				{
					...
					{
						$monto_igtf = round($pago->monto_igtf_dolar * $vectorPagos[$pago->bill->id]['tasaDolar'], 2);
						$monto_sin_igtf = round($pago->amount - $monto_igtf, 2);
					...
					{
						$monto_igtf = round($pago->monto_igtf_dolar/$vectorPagos[$pago->bill->id]['tasaDolarEuro'], 2);
						$monto_sin_igtf = round($pago->amount - $monto_igtf, 2);
