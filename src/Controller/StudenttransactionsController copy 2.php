    ...
    public function consultaDeudaRepresentante($idUsuario = null, $rolUsuario = null, $idRepresentante = null, $idEstudiante = null, $controlador = 'Users', $accion = 'wait')
    {
		if ($this->request->is('post'))
	    {
			if (isset($_POST['id_estudiante'])) 
			{
				...
				$this->set(compact('idUsuario', 'rolUsuario', 'idRepresentante', 'idEstudiante', 'estudiante', 'periodoEscolar', 'contadorTransacciones', 'transaccionesEstudiante', 'anioEscolarActual', 'registroEstudiante', 'mesesTarifas', 'otrasTarifas', 'controlador', 'accion'));
			}
			else
			{
				$this->Flash->error(__('No se indicó el nombre del estudiante'));
