...
class PaymentsController extends AppController
{
     ...
     */
    public function add($billId = null, $billNumber = null, $pago = null, $fiscal = null, $descuento_seguro = null) // Recibo de seguro
    {		
        $payment = $this->Payments->newEntity();
        $payment->bill_id = $billId;
        $payment->payment_type = $pago->paymentType;
        $payment->amount = round($pago->amountPaid - $descuento_seguro, 2); // Recibo de seguro
