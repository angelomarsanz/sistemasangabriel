...
class ProductosController extends AppController
{
    ...
    public function add()
    {
        ...
        $producto->requesting_user = $this->Auth->user('username');
        
        if ($this->Productos->save($producto)) 
        {
            $lastRecord = $this->Productos->find('all', ['conditions' => ['requesting_user' => $this->Auth->user('username')],
                'order' => ['Productos.created' => 'DESC'] ]);
        ...
        {
            $this->Flash->error(__('No se generó el número consecutivo para el recibo de producto, intente de nuevo'));
        }
    }
