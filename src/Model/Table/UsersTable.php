...
class UsersTable extends Table
{
    ...
    {
        $query
            ->select(['id', 'username', 'password', 'role', 'first_name', 'second_name', 'surname', 'second_surname', 'sex', 'email', 'cell_phone', 'profile_photo', 'profile_photo_dir', 'estatus_registro', 'created', 'modified']);
