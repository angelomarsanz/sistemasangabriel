...
/**
 * PositioncategoriesFixture
 *
 */
class PositioncategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'description_category' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'description_category' => 'Lorem ipsum dolor sit amet',
            ...
            'date_status' => '2018-06-04 00:15:57',
            'responsible_user' => 'Lorem ipsum dolor sit amet',
            'created' => '2018-06-04 00:15:57',
            'modified' => '2018-06-04 00:15:57'
        ],
    ];
}
