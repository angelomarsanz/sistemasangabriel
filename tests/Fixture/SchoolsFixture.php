...
class SchoolsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rif' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'fiscal_address' => ['type' => 'string', 'length' => 500, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'deleted_record' => 1,
            'created' => '2017-08-10 15:49:16',
            'modified' => '2017-08-10 15:49:16'
        ],
    ];
}
