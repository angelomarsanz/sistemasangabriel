...
class ConceptsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'accounting_code' => ['type' => 'string', 'length' => 500, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'concepts_ibfk_1' => ['type' => 'foreign', 'columns' => ['bill_id'], 'references' => ['bills', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'amount' => 1,
            'created' => '2017-03-23 11:12:10',
            'modified' => '2017-03-23 11:12:10'
        ],
    ];
}
