...
class StudentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sex' => ['type' => 'string', 'length' => 500, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'school_card' => ['type' => 'string', 'length' => 500, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'family_bond_guardian_student' => ['type' => 'string', 'length' => 500, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'place_of_birth' => ['type' => 'string', 'length' => 500, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'country_of_birth' => ['type' => 'string', 'length' => 500, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'level_of_study' => ['type' => 'string', 'length' => 1000, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'section_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'scholarship' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'brothers_in_school' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'number_of_brothers' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'previous_school' => ['type' => 'string', 'length' => 500, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'student_illnesses' => ['type' => 'string', 'length' => 1000, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'observations' => ['type' => 'string', 'length' => 1000, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'level_of_study_id' => ['type' => 'index', 'columns' => ['section_id'], 'length' => []],
            'user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'parentsandguardian_id' => ['type' => 'index', 'columns' => ['parentsandguardian_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'code for user' => ['type' => 'unique', 'columns' => ['code_for_user'], 'length' => []],
            'students_ibfk_1' => ['type' => 'foreign', 'columns' => ['section_id'], 'references' => ['sections', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'students_parentsandguardians' => ['type' => 'foreign', 'columns' => ['parentsandguardian_id'], 'references' => ['parentsandguardians', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'students_users' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'level_of_study' => 'Lorem ipsum dolor sit amet',
            'section_id' => 1,
            'scholarship' => 1,
            'brothers_in_school' => 1,
            'number_of_brothers' => 1,
            'previous_school' => 'Lorem ipsum dolor sit amet',
            'student_illnesses' => 'Lorem ipsum dolor sit amet',
            'observations' => 'Lorem ipsum dolor sit amet',
            'balance' => 1,
            'created' => '2017-01-08 13:21:22',
            'modified' => '2017-01-08 13:21:22'
        ],
    ];
}
